...
<body>
	...
	<c:url var="url_miniStatement" value="/miniStmtCallService"></c:url>
<h1 align="center">Mini Statement</h1>
	<f:form method="post" action='${url_miniStatement}'
		...
		<c:if test="${transactions!=null}">
				...
				<thead>
						<tr>
							...
							<th scope="col">__Date_and_Time__</th>
							<th scope="col">Amount(in_INR)</th>
							<th scope="col">Description__</th>
						</tr>
					</thead>
					<tbody>
